...
export declare type IResolveLinkType = IResolvedAudio | IResolvedPlaylist | IResolvedQuery | IResolvedAlbum;
export declare type IExecuteResponse<T> = {
    response: T;
    errors: unknown[];
};
...
declare type IThumbPhoto<T extends string> = {
    [k in `photo_${T}`]?: string;
};
export declare type IThumb = {
    width: number;
    height: number;
